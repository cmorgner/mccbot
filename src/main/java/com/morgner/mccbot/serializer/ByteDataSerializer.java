...
/**
 * A byte data serializer for the minecraft protocol.
 *
 * @author Christian Morgner
 */
public class ByteDataSerializer implements Serializer<ByteData> {

	@Override
	public ByteData deserialize(DataInputStream is) throws IOException {
	...
	@Override
	public void serialize(ByteData data, DataOutputStream os) throws IOException {
	}
}
